...
phase_to_data = { # [GT, raw_img, border_img, content_img]
    ...
    'clean' : ['../data/data/stop_sign_label.npy', '../data/data/stop_sign_X_test.npy', '../data/data/stop_sign_border_test.npy', '../data/data/stop_sign_content_test.npy'],
    # adversarial stop sign samples
    'adv' : ['../data/data/stop_sign_label.npy', '../data/data/stop_sign_adv_X_test.npy', '../data/data/stop_sign_adv_border_test.npy', '../data/data/stop_sign_adv_content_test.npy']
}
...
for main_sensor in main_sensor_list.keys():
    ...
    for phase in phase_to_data.keys():
        ...
        data = sensing_data(batch_size=40, train_data = None, test_data = [sensing_signals_path, gt_path])
        test(model,data)
        print('---------------------------------------\n')