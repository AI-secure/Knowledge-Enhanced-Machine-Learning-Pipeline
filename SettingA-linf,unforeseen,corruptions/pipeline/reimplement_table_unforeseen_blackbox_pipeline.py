...
phase_to_data = { # [GT, raw_img, border_img, content_img]
    ...
    'fog_256' : ['../data/data/raw_label_test.npy', '../data/data/[black_box_pipeline]fog_256_adv_X_test.npy', '../data/data/[black_box_pipeline]fog_256_adv_border.npy', '../data/data/[black_box_pipeline]fog_256_adv_content.npy'],

    'fog_512' : ['../data/data/raw_label_test.npy', '../data/data/[black_box_pipeline]fog_512_adv_X_test.npy', '../data/data/[black_box_pipeline]fog_512_adv_border.npy', '../data/data/[black_box_pipeline]fog_512_adv_content.npy'],

    'snow_0.25' : ['../data/data/raw_label_test.npy', '../data/data/[black_box_pipeline]snow_0.25_adv_X_test.npy', '../data/data/[black_box_pipeline]snow_0.25_adv_border.npy', '../data/data/[black_box_pipeline]snow_0.25_adv_content.npy'],

    'snow_0.75' : ['../data/data/raw_label_test.npy', '../data/data/[black_box_pipeline]snow_0.75_adv_X_test.npy', '../data/data/[black_box_pipeline]snow_0.75_adv_border.npy', '../data/data/[black_box_pipeline]snow_0.75_adv_content.npy'],

    'jpeg_0.125' : ['../data/data/raw_label_test.npy', '../data/data/[black_box_pipeline]jpeg_0.125_adv_X_test.npy', '../data/data/[black_box_pipeline]jpeg_0.125_adv_border.npy', '../data/data/[black_box_pipeline]jpeg_0.125_adv_content.npy'],

    'jpeg_0.25' : ['../data/data/raw_label_test.npy', '../data/data/[black_box_pipeline]jpeg_0.25_adv_X_test.npy', '../data/data/[black_box_pipeline]jpeg_0.25_adv_border.npy', '../data/data/[black_box_pipeline]jpeg_0.25_adv_content.npy'],

    'gabor_20' : ['../data/data/raw_label_test.npy', '../data/data/[black_box_pipeline]gabor_20_adv_X_test.npy', '../data/data/[black_box_pipeline]gabor_20_adv_border.npy', '../data/data/[black_box_pipeline]gabor_20_adv_content.npy'],

    'gabor_40' : ['../data/data/raw_label_test.npy', '../data/data/[black_box_pipeline]gabor_40_adv_X_test.npy', '../data/data/[black_box_pipeline]gabor_40_adv_border.npy', '../data/data/[black_box_pipeline]gabor_40_adv_content.npy'],

    'elastic_1.5' : ['../data/data/raw_label_test.npy', '../data/data/[black_box_pipeline]elastic_1.5_adv_X_test.npy', '../data/data/[black_box_pipeline]elastic_1.5_adv_border.npy', '../data/data/[black_box_pipeline]elastic_1.5_adv_content.npy'],

    'elastic_2.0' : ['../data/data/raw_label_test.npy', '../data/data/[black_box_pipeline]elastic_2.0_adv_X_test.npy', '../data/data/[black_box_pipeline]elastic_2.0_adv_border.npy', '../data/data/[black_box_pipeline]elastic_2.0_adv_content.npy'],
}
...
print('====================== Blackbox Pipeline Unforeseen Attack ======================')



phase_list = ['clean', 'fog_256', 'fog_512', 'snow_0.25', 'snow_0.75', 'jpeg_0.125', 'jpeg_0.25', 'gabor_20', 'gabor_40', 'elastic_1.5', 'elastic_2.0']
...
for main_sensor in main_sensor_list.keys():
    ...
    for phase in phase_list:
        ...
        path = signal_dir + '[black_box_pipeline]%s_signals_with_%s.npy' % (phase, main_sensor_name)
        np.save(path, VARS)
