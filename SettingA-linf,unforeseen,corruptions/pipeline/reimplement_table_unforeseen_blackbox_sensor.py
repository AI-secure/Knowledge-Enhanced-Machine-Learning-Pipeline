...
phase_to_data = { # [GT, raw_img, border_img, content_img]
    ...
    'fog_256' : ['../data/data/raw_label_test.npy', '../data/data/[black_box_sensor]fog_256_adv_X_test.npy', '../data/data/[black_box_sensor]fog_256_adv_border.npy', '../data/data/[black_box_sensor]fog_256_adv_content.npy'],

    'fog_512' : ['../data/data/raw_label_test.npy', '../data/data/[black_box_sensor]fog_512_adv_X_test.npy', '../data/data/[black_box_sensor]fog_512_adv_border.npy', '../data/data/[black_box_sensor]fog_512_adv_content.npy'],

    'snow_0.25' : ['../data/data/raw_label_test.npy', '../data/data/[black_box_sensor]snow_0.25_adv_X_test.npy', '../data/data/[black_box_sensor]snow_0.25_adv_border.npy', '../data/data/[black_box_sensor]snow_0.25_adv_content.npy'],

    'snow_0.75' : ['../data/data/raw_label_test.npy', '../data/data/[black_box_sensor]snow_0.75_adv_X_test.npy', '../data/data/[black_box_sensor]snow_0.75_adv_border.npy', '../data/data/[black_box_sensor]snow_0.75_adv_content.npy'],

    'jpeg_0.125' : ['../data/data/raw_label_test.npy', '../data/data/[black_box_sensor]jpeg_0.125_adv_X_test.npy', '../data/data/[black_box_sensor]jpeg_0.125_adv_border.npy', '../data/data/[black_box_sensor]jpeg_0.125_adv_content.npy'],

    'jpeg_0.25' : ['../data/data/raw_label_test.npy', '../data/data/[black_box_sensor]jpeg_0.25_adv_X_test.npy', '../data/data/[black_box_sensor]jpeg_0.25_adv_border.npy', '../data/data/[black_box_sensor]jpeg_0.25_adv_content.npy'],

    'gabor_20' : ['../data/data/raw_label_test.npy', '../data/data/[black_box_sensor]gabor_20_adv_X_test.npy', '../data/data/[black_box_sensor]gabor_20_adv_border.npy', '../data/data/[black_box_sensor]gabor_20_adv_content.npy'],

    'gabor_40' : ['../data/data/raw_label_test.npy', '../data/data/[black_box_sensor]gabor_40_adv_X_test.npy', '../data/data/[black_box_sensor]gabor_40_adv_border.npy', '../data/data/[black_box_sensor]gabor_40_adv_content.npy'],

    'elastic_1.5' : ['../data/data/raw_label_test.npy', '../data/data/[black_box_sensor]elastic_1.5_adv_X_test.npy', '../data/data/[black_box_sensor]elastic_1.5_adv_border.npy', '../data/data/[black_box_sensor]elastic_1.5_adv_content.npy'],

    'elastic_2.0' : ['../data/data/raw_label_test.npy', '../data/data/[black_box_sensor]elastic_2.0_adv_X_test.npy', '../data/data/[black_box_sensor]elastic_2.0_adv_border.npy', '../data/data/[black_box_sensor]elastic_2.0_adv_content.npy'],
}
...
print('====================== Blackbox Sensor Unforeseen Attack ======================')
