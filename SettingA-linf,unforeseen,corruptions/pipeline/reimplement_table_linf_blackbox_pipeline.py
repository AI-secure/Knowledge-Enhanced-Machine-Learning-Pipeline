...
phase_to_data = { # [GT, raw_img, border_img, content_img]
    ...
    'linf_4' : ['../data/data/raw_label_test.npy', '../data/data/[black_box_pipeline]pgd_4_adv_X_test.npy', '../data/data/[black_box_pipeline]pgd_4_adv_border.npy', '../data/data/[black_box_pipeline]pgd_4_adv_content.npy'],
        
    'linf_8' : ['../data/data/raw_label_test.npy', '../data/data/[black_box_pipeline]pgd_8_adv_X_test.npy', '../data/data/[black_box_pipeline]pgd_8_adv_border.npy', '../data/data/[black_box_pipeline]pgd_8_adv_content.npy'],

    'linf_16' : ['../data/data/raw_label_test.npy', '../data/data/[black_box_pipeline]pgd_16_adv_X_test.npy', '../data/data/[black_box_pipeline]pgd_16_adv_border.npy', '../data/data/[black_box_pipeline]pgd_16_adv_content.npy'],
       
    'linf_32' : ['../data/data/raw_label_test.npy', '../data/data/[black_box_pipeline]pgd_32_adv_X_test.npy', '../data/data/[black_box_pipeline]pgd_32_adv_border.npy', '../data/data/[black_box_pipeline]pgd_32_adv_content.npy'],
...
print('====================== Black-box Pipeline Linf Attack ======================')
