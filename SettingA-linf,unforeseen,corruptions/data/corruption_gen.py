...
common_corruption_mapping={
    '[corruption]fog_adv_X_test.npy' : '[corruption]fog_adv',
    '[corruption]contrast_adv_X_test.npy' : '[corruption]contrast_adv',
    '[corruption]brightness_adv_X_test.npy' : '[corruption]brightness_adv'
}


print('Generate border & content edge ......')

for file_path in common_corruption_mapping.keys():

    phase = common_corruption_mapping[file_path]
