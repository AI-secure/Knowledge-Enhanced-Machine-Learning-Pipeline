...
phase_to_data = { # [GT, raw_img, border_img, content_img]
    ...
    'fog' : ['../data/data/raw_label_test.npy', '../data/data/[corruption]fog_adv_X_test.npy', '../data/data/[corruption]fog_adv_border.npy', '../data/data/[corruption]fog_adv_content.npy'],
        
    'contrast' : ['../data/data/raw_label_test.npy', '../data/data/[corruption]contrast_adv_X_test.npy', '../data/data/[corruption]contrast_adv_border.npy', '../data/data/[corruption]contrast_adv_content.npy'],

    'brightness' : ['../data/data/raw_label_test.npy', '../data/data/[corruption]brightness_adv_X_test.npy', '../data/data/[corruption]brightness_adv_border.npy', '../data/data/[corruption]brightness_adv_content.npy']
...
for main_sensor in main_sensor_list.keys():
    ...
    for phase in phase_to_data.keys():
        ...
        path = signal_dir + '[corruption]%s_signals_with_%s.npy' % (phase, main_sensor_name)
        np.save(path, VARS)
