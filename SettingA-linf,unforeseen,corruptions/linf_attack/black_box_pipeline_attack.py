...
ckpt = torch.load('../substitute/sub_pipeline.ckpt',map_location=device)
...
for adv in adv_type:
    ...
    while st!= num:
        ...
        adv_batch = pgd_attack_random(sub_model,input_batch,gt_batch,eps=name_to_value[adv],alpha=1/255,iters=40,randomize=True)
    ...
    np.save('../data/data/[black_box_pipeline]%s_adv_X_test.npy' % (adv), adv_sample)